...
const helpOptions = [
  { value: 0, label: 'Documentation', href: 'https://sensetif.com/docs' },
  { value: 1, label: 'Tutorials', href: 'https://sensetif.com/tutorials' },
  { value: 2, label: 'Support', href: 'https://sensetif.com/support' },
...
export const WelcomeBanner: FC = () => {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>Welcome to Sensetif</h1>
